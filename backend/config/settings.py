...
BUSINESS_LEGAL_NAME = config("BUSINESS_LEGAL_NAME", default="Ultimate DJ")
BUSINESS_ADDRESS = config("BUSINESS_ADDRESS", default="")
BUSINESS_COMPANY_NUMBER = config("BUSINESS_COMPANY_NUMBER", default="")
BUSINESS_VAT_NUMBER = config("BUSINESS_VAT_NUMBER", default="")
