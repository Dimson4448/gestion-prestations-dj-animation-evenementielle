...
export default function PackageDetailPage({ detail }) {
  const { eventDate, location, navigate, selectedDj, selectedPackage, setEventDate, setLocation, startQuote } = detail;
